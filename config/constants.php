...
return [
    'YEAR_WEEKS' => array(
        ...
        array('title' => 'الاول من ابريل', 'date' => Carbon::parse($date)->addWeeks(13)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الثاني من ابريل', 'date' => Carbon::parse($date)->addWeeks(14)->format('Y-m-d'), 'is_vacation' => 0),
