...
return [
    'YEAR_WEEKS' => array(
        ...
        array('title' => 'الخامس من يونيو', 'date' => Carbon::parse($date)->addWeeks(21)->format('Y-m-d'), 'is_vacation' => 1),
        array('title' => 'الاول من يوليو', 'date' => Carbon::parse($date)->addWeeks(22)->format('Y-m-d'), 'is_vacation' => 0),
        ...
        array('title' => 'الرابع من اغسطس', 'date' => Carbon::parse($date)->addWeeks(30)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الاول من سبتمبر', 'date' => Carbon::parse($date)->addWeeks(31)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الثاني من سبتمبر', 'date' => Carbon::parse($date)->addWeeks(32)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الثالث من سبتمبر', 'date' => Carbon::parse($date)->addWeeks(33)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الرابع من سبتمبر', 'date' => Carbon::parse($date)->addWeeks(34)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الخامس من سبتمبر', 'date' => Carbon::parse($date)->addWeeks(35)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الاول من اكتوبر', 'date' => Carbon::parse($date)->addWeeks(36)->format('Y-m-d'), 'is_vacation' => 0),
        ...
        array('title' => 'الرابع من نوفمبر', 'date' => Carbon::parse($date)->addWeeks(44)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الاول من ديسمبر', 'date' => Carbon::parse($date)->addWeeks(45)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الثاني من ديسمبر', 'date' => Carbon::parse($date)->addWeeks(46)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الثالث من ديسمبر', 'date' => Carbon::parse($date)->addWeeks(47)->format('Y-m-d'), 'is_vacation' => 0),
        array('title' => 'الرابع من ديسمبر', 'date' => Carbon::parse($date)->addWeeks(48)->format('Y-m-d'), 'is_vacation' => 0),
