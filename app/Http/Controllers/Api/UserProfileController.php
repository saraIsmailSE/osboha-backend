...
class UserProfileController extends Controller
{
    ...
    public function profileStatistics($user_id)
    {
        ...
        $follow_up_group = Group::with('users')->where('id', $group_id)->first();
        $response['group_week_avg']= $this->groupAvg($group_id,  $response['week']->id, $follow_up_group->users->pluck('id'));
